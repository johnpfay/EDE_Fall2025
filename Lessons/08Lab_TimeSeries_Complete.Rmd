...
Similar to `lm` but allows for non-linear trend.


```{r}

# Exercise 9: Apply one of the trend detection test to the original data set. Remember that the data has seasonal component, which test can be applied in this case?
...
# Exercise 10: Now remove the seasonality and apply another test. Compare the results with what you obtained on Exercise 9.
...
#removing seasonality for rainfall
