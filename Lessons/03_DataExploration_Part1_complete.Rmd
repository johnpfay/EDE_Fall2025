...
> Answer: Warnings about "masked functions" and sometimes other messages regarding packages
...
> Answer: Converted to NA (missing value placeholder)
...
> Answer: If missing data can/should be discarded, then do so. But if they tell a story (e.g. broken device) keep them.
