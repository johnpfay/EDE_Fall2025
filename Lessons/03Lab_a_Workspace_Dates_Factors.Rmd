...
2.    Refer to the example code shown here (https://people.duke.edu/~jpfay/ENV872/here.html) to read in all CSV files starting with "EPAair_03" into a single dataframe. 
